...
Actively look for opportunities to extract **deep modules** — ones that encapsulate a lot of functionality behind a simple, testable interface that rarely changes.
...
- Reminder: run @to-tickets with the PRD path to generate backlog tickets
